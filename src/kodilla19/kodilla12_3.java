...
public class kodilla12_3 {
    <nazwa_kolumny> <typ_kolumny> [NOT NULL] [UNIQUE] [PRIMARY KEY] [CHARSET charset_name][,]

    PRIMARY KEY (col1, col2, …, colN)[,]

    lub

    FOREIGN KEY (col1, col2, …, colN) REFERENCES table_name (col3, col4, …, colK)[,]
